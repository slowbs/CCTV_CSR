...
if (isset($_GET['type'])) {
    ...
    if (!empty($type) && is_numeric($type)) {
        ...
        cctv.date_updated, cctv.status AS status_id, cctv.floor AS floor_id, floor.order AS floor_order, notify, cctv.maintenance_mode, cctv.map_id, cctv.map_x, cctv.map_y, cctv.map_rotation, cctv.image_path, cctv.switch_name
        FROM cctv
